...
WSDL.prototype.objectToXML = function(obj, name, namespace, xmlns, first, xmlnsAttr, parameterTypeObject, ancestorXmlns) {
  ...
  if (xmlns && first) {
    ...
    if (prefixNamespace && (!isSchemaNamespaceIgnored || this.ignoredNamespaces.indexOf(namespace) === -1)) {
  ...
  var ns = '';
  if (prefixNamespace && ((qualified || first) || soapHeader) && (!isSchemaNamespaceIgnored || this.ignoredNamespaces.indexOf(namespace) === -1)) {
    // prefix element
